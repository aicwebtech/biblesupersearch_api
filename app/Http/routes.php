...
Route::get('/api/v{version}/{action?}' , 'ApiController@versionedAction')->middleware($api_middleware);
Route::post('/api/v{version}/{action?}', 'ApiController@versionedAction')->middleware($api_middleware);
...
Route::post('/admin/bibles/audio/delete', 'Admin\AudioBibleController@delete');
