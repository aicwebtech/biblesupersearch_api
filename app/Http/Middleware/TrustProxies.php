 ...
 * ignored and Request::secure() is permanently FALSE, so the global
 * HttpsRedirect middleware cannot redirect such a request without looping. It
 * detects that case and serves the request instead, but only this middleware
 * makes the scheme actually correct.
 *
