...
abstract class TextAbstract extends RenderAbstract
{
    ...
    protected function _onRenderError(\Throwable $e) 
    {
        ...
        //
        // A removal that fails leaves exactly that situation in place, so it is raised
        // rather than swallowed. $e rides along as the previous exception: render()
        // rethrows whatever comes out of here, and the original cause must not be lost.
