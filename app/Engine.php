...
class Engine implements ErrorInterface
{
    ...
    public function actionBibles($input) 
    {
        ...
        foreach($Bibles as $Bible) {
            ...
            // _sanitizeHtml(), not _processHtml(): when bibles.copyright_statement is empty the
            // statement is generated by Copyright::getProcessedCopyrightStatement(), which no
